...
#ifndef CURRENCYEXCHANGE_SWIFT_H
#define CURRENCYEXCHANGE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CurrencyExchange",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16CurrencyExchange11AppDelegate")
...
SWIFT_CLASS("_TtC16CurrencyExchange30CurrencyExchangeViewController")
@interface CurrencyExchangeViewController : UIViewController
- (IBAction)exchangeButtonDidTap;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC16CurrencyExchange13SceneDelegate")
